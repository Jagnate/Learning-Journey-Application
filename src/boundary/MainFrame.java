...
public class MainFrame extends JFrame{
    ...
    private void setAchFrame(){
        achMenu.addMouseListener(new MouseAdapter(){
            public void mouseClicked(java.awt.event.MouseEvent e){        
                achFrame = new AchFrame(control.stu.getID());
                achFrame.setVisible(true);
            }
        });
    }
    
    private void setProFrame(){
        profileMenu.addMouseListener(new MouseAdapter(){
            public void mouseClicked(java.awt.event.MouseEvent e){        
                profileFrame = new ProfileFrame(control.stu.getName(),control.stu.getSchool(),control.stu.getMajor(),control.stu.getID(),control.stu.getYear());
