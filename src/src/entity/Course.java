...
public class Course {
    ...
    public boolean getTolearn()                     { return this.tolearn; }
 
    public void    setTolearn(Boolean tolearn)      { this.tolearn = tolearn; }
    ...
    public boolean getCourseType()                  { return this.courseType; }
 
    public void setCourseType(boolean courseType)   { this.courseType = courseType; }
