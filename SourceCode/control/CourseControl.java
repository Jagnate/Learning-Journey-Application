...
public class CourseControl{
    ...
    public void readCourses(String ID){
        try{
            FileReader     fileReader     = new FileReader("/Users/sijin/eclipse-workspace/Learning_Journey_Application/src/entity/StuCourse.txt");
    ...
    public void readGeneralInfo(){
        try{
            FileReader     fileReader     = new FileReader("/Users/sijin/eclipse-workspace/Learning_Journey_Application/src/entity/Courses.txt");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String         oneline        = bufferedReader.readLine();
            oneline = bufferedReader.readLine();
            int sum = 0;
    ...
    public void readPersonInfo(String ID, int year){
        try{
            FileReader     fileReader     = new FileReader("/Users/sijin/eclipse-workspace/Learning_Journey_Application/src/entity/StuGPA.txt");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String         oneline        = bufferedReader.readLine();
            oneline = bufferedReader.readLine();
            //Read a line one by one
